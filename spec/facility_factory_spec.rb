...
RSpec.describe FacilityFactory do
    ...
    describe "#create facilities" do
        it 'can create new facilites' do
            ...
            facilities = @facility.create_facilities(@co_facilities,"Colorado")
        ...
        it 'can create facilities at multiple locations' do
            ...
            facilities = @facility.create_facilities(@new_york_facilities, "New York")
            ...
            facilities = @facility.create_facilities(@missouri_facilities,"Missouri")
